...
@php
    $password_reset_url = View::getSection('password_reset_url') ?? config('adminlte.password_reset_url', 'password/email');
...
@section('auth_body')
    ...
    <form class="without-confirmation" action="{{ $password_reset_url }}" method="post">
        @csrf
