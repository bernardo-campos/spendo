...
@section('content_header')
    <div class="d-flex">
        ...
        <a href="{{ route('tags.create') }}" class="ml-auto">
            <x-adminlte-button label="Nueva etiqueta" theme="outline-primary"/>
        </a>
    </div>
@endsection
...
<div class="card">
    <div class="card-body">
        ...
        <table id="tags" class="table table-sm responsive nowrap">
        <thead>
            <tr>
                <th>Etiqueta</th>
